...
Issue #2 y el MVP de Issue #3A no añaden dependencias de runtime: usan APIs
estándar de Node y VS Code, con detección opcional de la extensión Ralph Suite.
Por tanto, no cambia el inventario del SBOM ni se instala Ralph Suite como
